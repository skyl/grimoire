...
(function() {
  var BASIC_MINOR_SONG, CommaPlayer, Fretboard, FretboardCanvas, FullChordPlayer, I_ONCE_KNEW_A_PRETTY_GIRL, MOST_BASIC_SONG, OscillatorPlayer, RandomArpPlayer, SILVER_DAGGER, STARIN_AT_THE_WALLS, START_SONG, TWINKLE, UpbeatChordPlayer, WAGON_WHEEL, chord_notes, color_map, full_c, get_full_chord, instruments, limit_notes, trans, _ref, _ref1, _ref2, _ref3,
  ...
  OscillatorPlayer = (function(_super) {
    __extends(OscillatorPlayer, _super);

    function OscillatorPlayer() {
      _ref3 = OscillatorPlayer.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
