...
(function() {
  var CommaPlayer, DEFAULT_SONG, Fretboard, FretboardCanvas, FretboardCommaPlayer, OscillatorPlayer, RandomArpPlayer, UpbeatChordPlayer, chord_notes, full_c, get_full_chord, instruments, limit_notes, trans,
  ...
  UpbeatChordPlayer = (function(superClass) {
    ...
    UpbeatChordPlayer.prototype.play = function(current_tick, time, tempo, metronome) {
      var high, low, notes, start, sustain, sustain_ticks, volume;
