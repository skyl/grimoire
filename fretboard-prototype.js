...
(function() {
  var CommaPlayer, Fretboard, FretboardCanvas, FullChordPlayer, I_ONCE_KNEW_A_PRETTY_GIRL, STARIN_AT_THE_WALLS, SongAnimator, chord_notes, full_c, get_full_chord, limit_notes, main, trans, _ref,
  ...
  FullChordPlayer = (function(_super) {
    ...
    FullChordPlayer.prototype.play_beat = function() {
      ...
      return MIDI.chordOff(0, notes, this.seconds_per_beat);
    };
