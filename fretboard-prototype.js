...
(function() {
  var CommaPlayer, Fretboard, FretboardCanvas, FullChordPlayer, I_ONCE_KNEW_A_PRETTY_GIRL, STARIN_AT_THE_WALLS, SongAnimator, chord_notes, full_c, get_full_chord, limit_notes, main, trans,
  ...
  FretboardCanvas = (function() {
    ...
    FretboardCanvas.prototype.draw_notes = function() {
      var centery, diff, pos, radius, string, _i, _j, _len, _len1, _ref, _results;
  ...
  SongAnimator = (function() {
    function SongAnimator(fbc, comma_song, tempo) {
      this.fbc = fbc;
    ...
    SongAnimator.prototype.draw = function() {
      ...
      this.position += 1;
      full_chord = get_full_chord(this.chord);
  ...
  CommaPlayer = (function() {
    ...
    CommaPlayer.prototype.start = function() {
      return this.timer = setTimeout(this.advance(), this.ms_per_beat);
    };
    ...
    CommaPlayer.prototype.advance = function() {
      ...
      this.fbc.replace(this.chord);
      this.position += 1;
      if (this.loop && this.position >= this.chords.length) {
        this.position = 0;
      }
  ...
  FullChordPlayer = (function() {
    ...
    FullChordPlayer.prototype.play_beat = function() {
      ...
      return MIDI.loadPlugin({
        ...
        callback: function() {
          var notes, sustain;
          sustain = _this.seconds_per_beat / 2;
          notes = limit_notes(get_full_chord(_this.chord));
          MIDI.chordOn(0, notes, 127, 0);
          return MIDI.chordOff(0, notes, seconds_per_beat);
        }
      });
    };
  ...
  main = function() {
    ...
    fbc.replace("A min7");
    return window.chord_player = new FullChordPlayer(fbc, STARIN_AT_THE_WALLS, 90);
  };
