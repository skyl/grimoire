...
(function() {
  var CommaPlayer, DEFAULT_SONG, Fretboard, FretboardCanvas, FretboardCommaPlayer, FullChordPlayer, OscillatorPlayer, RandomArpPlayer, UpbeatChordPlayer, chord_notes, full_c, get_full_chord, instruments, limit_notes, trans,
  ...
  OscillatorPlayer = (function(superClass) {
    ...
    OscillatorPlayer.prototype.play = function(current_tick, time, tempo, metronome) {
      var ac, freq, gNode, gain, notes, osc, sustain;
  ...
  fretboardApp.controller('FretboardChanger', function($scope, $location) {
    ...
    $scope.oscillator_on_change = function() {
      return $scope.oscillator_player.off = !$scope.oscillator_on;
    };
    $scope.oscillator_sustain_change = function() {
      return $scope.oscillator_player.options.sustain = Number($scope.oscillator_sustain);
    };
    $scope.oscillator_gain_change = function() {
      return $scope.oscillator_player.options.gain = Number($scope.oscillator_gain);
    };
    $scope.oscillator_tick_multiple_change = function() {
      return $scope.oscillator_player.options.tick_multiple = Number($scope.oscillator_tick_multiple);
    };
    $scope.chords_on_change = function() {
      return $scope.chord_player.off = !$scope.chords_on;
    };
    $scope.init = function() {
      ...
      $scope.metronome.players = [$scope.fbcp, new RandomArpPlayer($scope.comma_song, $scope.metronome, $scope), $scope.chord_player, $scope.oscillator_player];
      $scope.limit_notes_change();
